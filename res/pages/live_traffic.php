...

{
    ...
    function wwaPluginValidateSettingsForm($settings, $refreshRates)
...

    {
...

        {
            ...
            $settings = wwaPluginValidateSettingsForm($settings, $refreshRates);
...
<style type="text/css">
    ...
    .wwa-clear { float: none; clear: both; height: 0; width: 100%; margin: 0 0; padding: 0 0;}

    .wwaTrafficScan { }

    .wwa-scan-entry { border-bottom: solid 1px #000; }

    .wwa-scan-entry p { margin: 0 0; padding: 0 0;  font-size: 100%; }

    .wwa-scan-entry p .w-entry { color: #21759B; }

    .wwa-scan-entry p .w-ip { color: #d00000; }

    .wwa-scan-entry p .w-ua { color: #808080; }

    .wwa-scan-entry p .w-date { color: #006600; }
    ...
    .wwaPluginFieldsetSettingsExpanded { background: #F9F9F9; border: solid 1px #DFDFDF; padding: 0 0; }

    .wwaPluginFieldsetSettingsCollapsed { background: transparent; border: none; border-top: solid 1px #DFDFDF; padding: 0 0; }
...
<div class="wrap wwaplugin_content">
    ...
    <h2><?php echo WWA_PLUGIN_NAME.' - '. __('Live Traffic');?></h2>
    ...
    <div style="padding: 0 0;">
        ...
        <form method="post">
            ...
            <fieldset class="wwaPluginFieldsetSettingsExpanded">
    ...
    <table id="wwaTrafficScanTable" cellspacing="0"

           class="wp-list-table widefat wwaTrafficScan"

           data-nonce="<?php echo wp_create_nonce("wwaTrafficScan_nonce");?>"

           data-lastid="<?php echo WwaLiveTraffic::getLastID();?>">
...

        {
...

            {
                ...
                $.ajax({
                    ...
                    data : {'action': "ajaxGetTrafficData", 'nonce': nonce, 'lastID' : lastID, 'forceLoad': wwaAjaxForceLoad, 'maxEntries' : <?php echo $keepNumEntriesLiveTraffic;?>},
            ...
            ?>
                ...
                window.setInterval(function(){wwapluginLoadData(); }, <?php echo $liveTrafficRefreshRateAjax * 1000 ?>);
