...
class WwaSecurity extends WwaPlugin

{
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_version_hidden']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_version_hidden']['type'];



        if(! self::isSettingEnabled(__FUNCTION__)){

            self::alert($actionName, $alertType, WWA_PLUGIN_ALERT_CRITICAL,
        ...
        $isAdmin = WwaUtil::isAdministrator();
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_generators_frontend']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_generators_frontend']['type'];
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_rsd_frontend']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_rsd_frontend']['type'];
        ...
        if (!is_admin()) {
            ...
            if(!WwaUtil::isAdministrator() && function_exists('rsd_link')) {
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_wlw_frontend']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_wlw_frontend']['type'];
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_error_reporting']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_error_reporting']['type'];
        if(! self::isSettingEnabled(__FUNCTION__)){
            ...
            self::alert($actionName, $alertType, WWA_PLUGIN_ALERT_CRITICAL,
                ...
                sprintf(__('<p>By default, WordPress hides database errors, but there are times when a plugin might enable them thus it is very important to have this type of errors turned off
                    ...
                    'Disable error reporting (php + db) for all but administrators', 'http://www.worldwebarts.com/', '_blank'),
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_core_update_notif']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_core_update_notif']['type'];
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_plugins_update_notif']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_plugins_update_notif']['type'];
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_themes_update_notif']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_themes_update_notif']['type'];
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_login_errors']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_login_errors']['type'];
        ...
        $str = '<link rel="stylesheet" type="text/css" href="'.WwaUtil::cssUrl('acx-styles-extra.css').'"/>';
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_admin_notices']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_admin_notices']['type'];
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_dir_listing']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_dir_listing']['type'];
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_index_content']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_index_content']['type'];
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_index_plugins']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_index_plugins']['type'];
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_index_themes']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_index_themes']['type'];
        ...
        $actionName = $wwaPluginAlertsArray['fix_wp_index_uploads']['name'];

        $alertType = $wwaPluginAlertsArray['fix_wp_index_uploads']['type'];
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_remove_wp_version_links']['name'];

        $alertType = $wwaPluginAlertsArray['fix_remove_wp_version_links']['type'];
...

        {
            ...
            add_filter('script_loader_src', array('WwaSecurityHelper', '__removeWpVersionFromLinks'));

            add_filter('style_loader_src', array('WwaSecurityHelper', '__removeWpVersionFromLinks'));
...

    {
        ...
        $actionName = $wwaPluginAlertsArray['fix_empty_root_readme_file']['name'];

        $alertType = $wwaPluginAlertsArray['fix_empty_root_readme_file']['type'];
