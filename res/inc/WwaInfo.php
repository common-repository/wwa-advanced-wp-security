...

{
...

    {
        ...
        if (strcasecmp('wp_', $table_prefix)==0) {
            ...
            .'(<a href="http://www.worldwebarts.com/" target="_blank">'.__('read more').'</a>)</span>';
...

    {
        ...
        if (WwaSecurity::$isVersionHidden) {
...
class WwaInfoServer extends WwaInfo

{
...

    {
        ...
        $str = '<script type="text/javascript" src="'. WwaUtil::jsUrl('wwaplugin_glossary_tooltip.js').'"></script>';
        ...
        $str .= '<li class="wwaplugin-tooltip" onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$sqlModeText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('SQL Mode').' : <strong>'.$sql_mode.'</strong></li>';

        $str .= '<li class="wwaplugin-tooltip" onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$phpSafeModeText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('PHP Safe Mode').' : <strong>'. $safe_mode.'</strong></li>';

        $str .= '<li class="wwaplugin-tooltip" onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$phpAllowFopenText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('PHP Allow URL fopen').' : <strong>'. $allow_url_fopen.'</strong></li>';

        $str .= '<li class="wwaplugin-tooltip" onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$phpMemoryLimitText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('PHP Memory Limit').' : <strong>'. $memory_limit.'</strong></li>';

        $str .= '<li class="wwaplugin-tooltip"onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$phpMaxUploadSizeText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('PHP Max Upload Size').' : <strong>'. $upload_max.'</strong></li>';

        $str .= '<li class="wwaplugin-tooltip" onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$phpMaxPostSizeText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('PHP Max Post Size').' : <strong>'. $post_max.'</strong></li>';

        $str .= '<li class="wwaplugin-tooltip" onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$phpScriptExecTimeText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('PHP Max Script Execute Time').' : <strong>'. $max_execute.'s</strong></li>';

        $str .= '<li class="wwaplugin-tooltip" onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$exifText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('PHP Exif support').' : <strong>'. $exif.'</strong></li>';

        $str .= '<li class="wwaplugin-tooltip" onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$iptcText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('PHP IPTC support').' : <strong>'. $iptc.'</strong></li>';

        $str .= '<li class="wwaplugin-tooltip" onmouseover="wwaplugin_glossary_tooltip.show(this);" data-bind-title="'.$xmlText.'" onmouseout="wwaplugin_glossary_tooltip.hide();">'. __('PHP XML support').' : <strong>'. $xml.'</strong></li>';
